...
bool matrix_interfaces__srv__rotxyz__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // matrizz
    PyObject * field = PyObject_GetAttrString(_pymsg, "matrizz");
    if (!field) {
      return false;
    }
    if (PyObject_CheckBuffer(field)) {
      ...
      double * dest = ros_message->matrizz.data;
      ...
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'matrizz'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
...
PyObject * matrix_interfaces__srv__rotxyz__response__convert_to_py(void * raw_ros_message)
{
  ...
  {  // matrizz
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "matrizz");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->matrizz.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->matrizz.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->matrizz.size * sizeof(double));
      assert(data != NULL);

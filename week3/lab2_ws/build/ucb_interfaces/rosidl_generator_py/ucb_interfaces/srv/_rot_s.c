...
bool ucb_interfaces__srv__rot__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ucb_interfaces.srv._rot.Rot_Request", full_classname_dest, 35) == 0);
  }
  ucb_interfaces__srv__Rot_Request * ros_message = _ros_message;
  {  // angle
  ...
  {  // px
    ...
    assert(PyLong_Check(field));
    ros_message->px = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // py
    ...
    assert(PyLong_Check(field));
    ros_message->py = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
  {  // pz
    ...
    assert(PyLong_Check(field));
    ros_message->pz = PyLong_AsLongLong(field);
    Py_DECREF(field);
  }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * ucb_interfaces__srv__rot__request__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Rot_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ucb_interfaces.srv._rot");
  ...
  ucb_interfaces__srv__Rot_Request * ros_message = (ucb_interfaces__srv__Rot_Request *)raw_ros_message;
  {  // angle
    PyObject * field = NULL;
  ...
  {  // px
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->px);
    {
  ...
  {  // py
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->py);
    {
  ...
  {  // pz
    PyObject * field = NULL;
    field = PyLong_FromLongLong(ros_message->pz);
    {
...
ROSIDL_GENERATOR_C_EXPORT
bool ucb_interfaces__srv__rot__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ucb_interfaces.srv._rot.Rot_Response", full_classname_dest, 36) == 0);
  }
  ucb_interfaces__srv__Rot_Response * ros_message = _ros_message;
  {  // fx
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * ucb_interfaces__srv__rot__response__convert_to_py(void * raw_ros_message)
{
  ...
  ucb_interfaces__srv__Rot_Response * ros_message = (ucb_interfaces__srv__Rot_Response *)raw_ros_message;
  {  // fx
    PyObject * field = NULL;

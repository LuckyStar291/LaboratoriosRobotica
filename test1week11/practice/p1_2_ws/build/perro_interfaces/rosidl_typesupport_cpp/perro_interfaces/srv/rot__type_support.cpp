...
static const _Rot_Request_type_support_symbol_names_t _Rot_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, perro_interfaces, srv, Rot_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, perro_interfaces, srv, Rot_Request)),
  }
};
...
{
  return &::perro_interfaces::srv::rosidl_typesupport_cpp::Rot_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, perro_interfaces, srv, Rot_Request)() {
  return get_message_type_support_handle<perro_interfaces::srv::Rot_Request>();
}
...
static const _Rot_Response_type_support_symbol_names_t _Rot_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, perro_interfaces, srv, Rot_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, perro_interfaces, srv, Rot_Response)),
  }
};
...
{
  return &::perro_interfaces::srv::rosidl_typesupport_cpp::Rot_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, perro_interfaces, srv, Rot_Response)() {
  return get_message_type_support_handle<perro_interfaces::srv::Rot_Response>();
}
...
static const _Rot_type_support_symbol_names_t _Rot_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, perro_interfaces, srv, Rot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, perro_interfaces, srv, Rot)),
  }
};
...
{
  return &::perro_interfaces::srv::rosidl_typesupport_cpp::Rot_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, perro_interfaces, srv, Rot)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<perro_interfaces::srv::Rot>();
}

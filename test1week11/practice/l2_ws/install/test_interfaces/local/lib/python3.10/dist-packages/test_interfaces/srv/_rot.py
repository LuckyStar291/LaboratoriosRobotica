...
class Rot_Request(metaclass=Metaclass_Rot_Request):
    ...
    def pz(self, value):
        if __debug__:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'pz' field must be an integer in [-2147483648, 2147483647]"
        self._pz = value
...
class Metaclass_Rot(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from test_interfaces.srv import _rot
...
class Rot(metaclass=Metaclass_Rot):
    from test_interfaces.srv._rot import Rot_Request as Request
    from test_interfaces.srv._rot import Rot_Response as Response

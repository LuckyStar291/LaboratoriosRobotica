...
bool test_interfaces__srv__rot__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("test_interfaces.srv._rot.Rot_Request", full_classname_dest, 36) == 0);
  }
  test_interfaces__srv__Rot_Request * ros_message = _ros_message;
  {  // angle
  ...
  {  // pz
    ...
    assert(PyLong_Check(field));
    ros_message->pz = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * test_interfaces__srv__rot__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("test_interfaces.srv._rot");
  ...
  {  // pz
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->pz);
    {
...
ROSIDL_GENERATOR_C_EXPORT
bool test_interfaces__srv__rot__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("test_interfaces.srv._rot.Rot_Response", full_classname_dest, 37) == 0);
  }
  test_interfaces__srv__Rot_Response * ros_message = _ros_message;
  {  // fx

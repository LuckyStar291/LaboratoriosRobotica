...
#ifndef TEST_INTERFACES__SRV__DETAIL__ROT__FUNCTIONS_H_
#define TEST_INTERFACES__SRV__DETAIL__ROT__FUNCTIONS_H_
 ...
 * calls
 * test_interfaces__srv__Rot_Request__init().
...
/**
 * It calls
 * test_interfaces__srv__Rot_Request__fini()
 ...
 * test_interfaces__srv__Rot_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * test_interfaces__srv__Rot_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * test_interfaces__srv__Rot_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_test_interfaces
...
/**
 * It calls
 * test_interfaces__srv__Rot_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_test_interfaces
...
/**
 * It allocates the memory for the array and calls
 * test_interfaces__srv__Rot_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_test_interfaces
...
/**
 * It calls
 * test_interfaces__srv__Rot_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TEST_INTERFACES__SRV__DETAIL__ROT__FUNCTIONS_H_

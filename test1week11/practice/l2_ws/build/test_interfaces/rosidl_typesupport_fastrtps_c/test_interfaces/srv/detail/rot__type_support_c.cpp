...
#include "test_interfaces/srv/detail/rot__rosidl_typesupport_fastrtps_c.h"
...
using _Rot_Request__ros_msg_type = test_interfaces__srv__Rot_Request;
...
size_t get_serialized_size_test_interfaces__srv__Rot_Request(
  const void * untyped_ros_message,
...
static uint32_t _Rot_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_test_interfaces__srv__Rot_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_test_interfaces
size_t max_serialized_size_test_interfaces__srv__Rot_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = test_interfaces__srv__Rot_Request;
    is_plain =
      (
...
static size_t _Rot_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_test_interfaces__srv__Rot_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_interfaces, srv, Rot_Request)() {
...
using _Rot_Response__ros_msg_type = test_interfaces__srv__Rot_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_test_interfaces
size_t get_serialized_size_test_interfaces__srv__Rot_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Rot_Response__ros_msg_type * ros_message = static_cast<const _Rot_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_test_interfaces__srv__Rot_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_test_interfaces
size_t max_serialized_size_test_interfaces__srv__Rot_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = test_interfaces__srv__Rot_Response;
    is_plain =
      (
...
static size_t _Rot_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_test_interfaces__srv__Rot_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_interfaces, srv, Rot_Response)() {
...
// already included above
// #include "test_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "test_interfaces/srv/rot.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_interfaces, srv, Rot)() {
  return &Rot__handle;
}
